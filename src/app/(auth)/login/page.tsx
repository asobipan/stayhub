...
export default function LoginPage() {
  ...
  return (
    <div
      className='h-[calc(100vh-4rem)] overflow-hidden flex'
      ...
      >
        ...
        <div className='relative z-10 flex flex-col justify-between h-full p-8 xl:p-10'>
          ...
          <div>
            ...
            >
              Тисячі унікальних помешкань по всьому світу. Від затишних
              апартаментів до розкішних вілл — оберіть ідеальне місце для
              відпочинку.
            </p>
          </div>
          ...
          {tab === "register" && (
            <form onSubmit={handleRegisterSubmit} className='space-y-3'>
              ...
              <Field
                ...
                onChange={(v) =>
                  setRegisterData((d) => ({ ...d, password: v }))
                }
...
function SubmitButton({
  ...
  return (
    <button
      ...
      onMouseEnter={(e) => {
        if (!loading)
          (e.target as HTMLButtonElement).style.background = "#312E81";
      }}
      onMouseLeave={(e) => {
        if (!loading)
          (e.target as HTMLButtonElement).style.background = "#1E1B4B";
      }}
    >
