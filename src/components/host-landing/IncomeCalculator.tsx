    ...
    <section id="calc" style={{ background: "var(--bg)" }}>
      <div className="max-w-300 mx-auto px-6 py-16 lg:py-24">
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-12">
          <div>
            ...
            >
              Скільки заробиш
              <br />
              <em style={{ fontStyle: "italic" }}>саме ти</em>?
            </h2>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* Inputs */}
          <div
            className="flex flex-col gap-8 p-8 rounded-2xl border"
              ...
              <div className="flex items-center gap-4">
                ...
                >
                  <button
                    ...
                    className="w-10 h-10 flex items-center justify-center text-xl transition-colors hover:bg-(--bg-alt)"
                    style={{ color: "var(--ink)" }}
                  >
                    −
                  </button>
                  <span
                    className="w-10 text-center font-serif text-[22px]"
                    style={{ color: "var(--ink)" }}
                  >
                    {bedrooms}
                  </span>
          ...
          >
            ...
            <ul className="flex flex-col gap-3 mb-8 flex-1">
              {[
                {
                  label: "Ціна за ніч",
                  value: `₴${fmt(uah(basePerNight))}`,
                  minus: false,
                },
                {
                  label: "Зайнято в середньому",
                  value: `${nightsBooked} ночей`,
                  minus: false,
                },
                {
                  label: "Дохід брутто / міс",
                  value: `₴${fmt(uah(monthly))}`,
                  minus: false,
                },
                {
                  label: "Сервісний збір StayHub 12%",
                  value: `−₴${fmt(uah(fee))}`,
                  minus: true,
                },
            ...
            >
              Розрахунок базується на середньому за останні 90 днів. Реальний
              дохід залежить від сезону, локації та якості оголошення.
            </p>
