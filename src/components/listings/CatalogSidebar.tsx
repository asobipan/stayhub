...
const AMENITIES = [
  ...
  },
  {
    id: "kitchen",
    label: "Кухня",
    icon: "M3 2h18v7a4 4 0 01-4 4H7a4 4 0 01-4-4V2zm0 7h18M12 13v9M8 22h8",
  },
  {
    id: "parking",
    label: "Парковка",
    icon: "M5 17H3a2 2 0 01-2-2V5a2 2 0 012-2h11a2 2 0 012 2v3M13 21h8M13 13h8m-8 4h4",
  },
  {
    id: "pool",
    label: "Басейн",
    icon: "M2 12h20M2 16h20M2 8a5 5 0 005-5 5 5 0 005 5 5 5 0 005-5 5 5 0 005 5",
  },
  {
    id: "ac",
    label: "Кондиціонер",
    icon: "M8 4H6a2 2 0 00-2 2v12a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-2M8 4V2m8 2V2M8 4h8",
  },
  {
    id: "washer",
    label: "Пральня",
    icon: "M3 3h18v18H3zM12 8a4 4 0 100 8 4 4 0 000-8zm0 0v1m0 6v1m-3-3H8m8 0h1",
  },
  {
    id: "tv",
    label: "Телевізор",
    icon: "M21 3H3a2 2 0 00-2 2v12a2 2 0 002 2h18a2 2 0 002-2V5a2 2 0 00-2-2zM8 21h8m-4-4v4",
  },
  {
    id: "workspace",
    label: "Робоче місце",
    icon: "M2 3h20v14H2zM8 21h8m-4-4v4",
  },
];
...
export function CatalogSidebar() {
  ...
  const activeAmenities = new Set(
    filters.amenities ? filters.amenities.split(",").filter(Boolean) : [],
  );
  ...
  return (
    <aside className="sh-filters">
      <div className="px-6 py-6 pb-10 flex flex-col">
        <h3 className="flex items-center justify-between font-serif text-[1.25rem] font-normal text-[var(--ink)] mb-5">
          <span>Фільтри</span>
          {hasFilters && (
            <button
              className="text-[11px] font-medium text-[var(--ink-2)] underline bg-none border-none cursor-pointer hover:text-[var(--accent)]"
              onClick={reset}
            >
              Скинути
            </button>
        ...
        <div className="sh-filter-block">
          <div className="sh-filter-lbl">
            ...
            <span className="text-[12px] font-normal text-[var(--ink-2)]">
          ...
          />
          <div className="flex justify-between text-[11px] text-[var(--ink-2)] font-mono-sh">
            <span>$20</span>
            <span>$500+</span>
          </div>
        </div>
...
function RangeSlider({
  ...
  return (
    <div className="sh-slider" ref={trackRef}>
      <div className="absolute left-0 right-0 h-[3px] bg-[var(--line)] rounded-sm" />
      <div
        className="absolute h-[3px] bg-[var(--ink)] rounded-sm"
        style={{ left: `${pct(v1)}%`, right: `${100 - pct(v2)}%` }}
      />
      <button
...
function ToggleRow({
  ...
  return (
    <button className="sh-toggle-row" onClick={() => onChange(!checked)}>
      ...
      <span className={`sh-switch ${checked ? "on" : ""}`}>
        <span />
      </span>
    </button>
  );
