    ...
    <div style={{ background: "var(--bg)", minHeight: "100vh" }}>
      ...
      >
        <div className="max-w-[1200px] mx-auto px-6 py-10 lg:py-14">
          <nav
            className="flex items-center gap-2 font-mono text-[10.5px] uppercase tracking-widest mb-6"
          ...
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8">
            <div>
              <p
                className="font-mono text-[10.5px] uppercase tracking-widest mb-3"
              ...
              >
                Місця, які ти
                <br />
                <em style={{ fontStyle: "italic" }}>відклав на потім</em>
              </h1>
              <p
                className="text-[15px] max-w-[480px]"
                style={{ color: "var(--ink-2)" }}
              >
                Натискай ♥ на будь-якому оголошенні — воно з'явиться тут.
                Повертайся, коли будеш готовий бронювати.
              </p>
            </div>
...
function SavedGridCard({
  ...
  return (
    <div className="flex flex-col group">
      <div
        className="relative aspect-[4/3] rounded-[14px] overflow-hidden mb-3"
      ...
      <div className="flex flex-col gap-1 px-0.5">
        <div className="flex items-start justify-between gap-2">
          ...
          {l.reviewCount > 0 && (
            <span
              className="flex items-center gap-1 text-[13px] font-medium shrink-0 mt-0.5"
              style={{ color: "var(--ink)" }}
            >
        ...
        <p
          className="flex items-center gap-1 text-[12.5px] truncate"
          style={{ color: "var(--sh-muted)" }}
        >
          <PinIcon size={11} />
          {l.city}, {l.country}
        ...
        <p className="text-[14px] mt-1" style={{ color: "var(--ink)" }}>
          ...
          <span className="text-[12.5px]" style={{ color: "var(--sh-muted)" }}>
            {" "}
            /ніч
          </span>
        </p>
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <p
          className="flex items-center gap-1 text-[12px] mt-0.5 truncate"
          style={{ color: "var(--sh-muted)" }}
        >
          <PinIcon size={10} />
          {l.city}, {l.country}
      ...
      {l.reviewCount > 0 && (
        <span
          className="flex items-center gap-1 text-[13px] font-medium shrink-0"
          style={{ color: "var(--ink)" }}
        >
          <StarFillIcon size={11} className="text-[var(--accent)]" />
...
function EmptyState() {
  return (
    <div className="flex flex-col items-center text-center py-24">
      ...
      <p
        className="text-[14px] mb-8 max-w-[360px]"
        style={{ color: "var(--ink-2)" }}
      >
